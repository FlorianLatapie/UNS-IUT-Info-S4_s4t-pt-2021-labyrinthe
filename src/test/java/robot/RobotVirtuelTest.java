...
class RobotVirtuelTest {
	RobotVirtuel rb;
	String[][] matLaby = { { null, null, null, null, null, null }, { null, null, null, null, null, null },
	...
	void creerMatriceRobotTest() {
		String[][] stringTest1 = { { null, "H", null, null }, { null, null, null, null }, { null, null, null, null }, };
		int[] posDepart1 = { 0, 1 };
		...
		String[][] stringTest2 = { { null, null }, { null, null }, { "D", null }, };
		int[] posDepart2 = { 2, 0 };
		...
		String[][] stringTest3 = { { null, null, null, null, null, null }, { null, null, null, null, "B", null },
				{ null, null, null, null, null, null }, { null, null, null, null, null, null }, };
		int[] posDepart3 = { 1, 4 };
	...
	@Test
	void deuxLignesTest() {
		String[][] matTest = { { null, null, null, null, null, null }, { null, null, null, null, null, null },
				{ null, null, null, null, null, null }, { null, null, null, null, "DLV", null }, };
		int[] pos = { 3, 4 };
	...
	void bougerTest() {
		RobotVirtuel rv = new RobotVirtuel();
		String[][] mLaby = { { null, null, null }, { null, null, null }, { null, null, null }, };
		String[][] mRobot = { { null, null, null }, { null, "H", null }, { null, null, null }, };
	...
	void bougerRobotTest() {
		RobotVirtuel rv = new RobotVirtuel();
		String[][] mRobot = { { null, null, null }, { null, null, null }, { "H", null, null }, };
	...
	void avancerTest() {
		...
		RobotVirtuel rv = new RobotVirtuel();
		String[][] mRobot = { { null, null, null }, { null, null, null }, { "H", "B", null }, };
		rv.avancer(mRobot);
		...
		String[][] mRobot2 = { { null, null, null }, { null, null, null }, { "H", "B", null }, };
		mRobot2[0][1] = "G";
		rv.avancer(mRobot2);
	...
	void droiteTest() {
		...
		String[][] mRobotD = { { null, null, null }, { "D", null, "H" }, { null, null, null }, };
		rv.droite(mRobotD);
		assertEquals(mRobotD[1][0], "B");
		assertEquals(mRobotD[1][1], null);

		String[][] mRobotB = { { "B", null, null }, { null, null, null }, { null, null, null }, };
		rv.droite(mRobotB);
		assertEquals(mRobotB[0][0], "G");

		String[][] mRobotG = { { null, null, null }, { null, "G", null }, { null, null, null }, };
		rv.droite(mRobotG);
	...
	void getDirRobotTest() {
		...
		String[][] mRobot2 = { { null, null, null }, { null, null, null }, { null, null, "B" }, };
		assertEquals(rv.getDirRobot(mRobot), "H");
		assertEquals(rv.getDirRobot(mRobot2), "B");
		String[][] mRobot3 = { { null, null, null }, { null, null, null }, { null, null, null } };
	}

	@Test
	void getPosRobotTest() {
		RobotVirtuel rv = new RobotVirtuel();
		String[][] mRobot = { { null, null, null }, { null, null, null }, { "H", null }, };
		int[] tab = rv.getPosRobot(mRobot);
		assertEquals(tab[0], 2);
		assertEquals(tab[1], 0);

		String[][] mRobot2 = { { null, null, null }, { null, null, null }, { null, null, null } };
