		...
		if (capteur.equals("101")) {
			...
			if (direction == 0) {
				if ((TraceAlgoArrive.grille[x - 1][y] == 2) && (TraceAlgoArrive.grille[x][y + 1] == 2)) {
					...
					return StaticProtocolMessages.GAUCHE + StaticProtocolMessages.GAUCHE
							+ StaticProtocolMessages.AVANCER;
				}
			...
			if (arrive == 1) {
				...
				if (direction == 0) {
					...
					if ((TraceAlgoArrive.grille[x][y - 1] == 0) && (TraceAlgoArrive.grille[x][y + 1] == 0)
							&& (TraceAlgoArrive.grille[x - 1][y] == 0)) {
						Random r = new Random();
					...
					else if ((TraceAlgoArrive.grille[x][y - 1] == 2) && (TraceAlgoArrive.grille[x][y + 1] == 2)
							&& (TraceAlgoArrive.grille[x - 1][y] == 0)) {
						TraceAlgoArrive.grille[x + 1][y] = 2;
						TraceAlgoArrive.grille[x - 1][y] = 2;
						x--;
					...
					else if ((TraceAlgoArrive.grille[x][y - 1] == 3) && (TraceAlgoArrive.grille[x][y + 1] == 3)
							&& (TraceAlgoArrive.grille[x - 1][y] == 2)) {
						TraceAlgoArrive.grille[x + 1][y] = 3;
						TraceAlgoArrive.grille[x - 1][y] = 3;
						x--;
					...
					if ((TraceAlgoArrive.grille[x - 1][y] == 0) && (TraceAlgoArrive.grille[x + 1][y] == 0)
							&& (TraceAlgoArrive.grille[x][y - 1] == 0)) {
						Random r = new Random();
						int rand = r.nextInt(3);
						if (rand == 0) {
							TraceAlgoArrive.grille[x + 1][y] = 2;
					...
					else if ((TraceAlgoArrive.grille[x - 1][y] == 2) && (TraceAlgoArrive.grille[x + 1][y] == 2)
							&& (TraceAlgoArrive.grille[x][y - 1] == 0)) {
						TraceAlgoArrive.grille[x][y - 1] = 2;
						TraceAlgoArrive.grille[x][y + 1] = 2;
						y--;
					...
					else if ((TraceAlgoArrive.grille[x - 1][y] == 3) && (TraceAlgoArrive.grille[x + 1][y] == 3)
							&& (TraceAlgoArrive.grille[x][y - 1] == 2)) {
						TraceAlgoArrive.grille[x][y + 1] = 3;
						TraceAlgoArrive.grille[x][y - 1] = 3;
						y--;
